<footer style="background-color: #81d742 !important;">
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<h4>GIỚI THIỆU</h4>
				<ul>
					<li>LIÊN HỆ NHÀ PHÂN PHỐI TUANANH</li>
					<li><i class="bi bi-mailbox2"></i> tuananh.com@gmail.com</li>
			...
			<div class="col-md-4">
				...
				<ul>
					<li>LIÊN HỆ NHÀ PHÂN PHỐI TUANANH</li>
					<li>Email: tuananh.com@gmail.com</li>
	...
	<div style="background-color: #3f9609; width: 100%; text-align: center; padding: 20px;">
		© 2023 . Được thiết kế bời TuanAnh BKHN . All rights reserved.
	</div>
</footer>
